...
import dev.lupluv.kc.utils.ReactionRole;
import dev.lupluv.kc.utils.Util;
                    ...
                    if(command.equalsIgnoreCase(".help")){
                        ...
                        if(args.length == 3){
                            if(!message.getMentions().getMembers().isEmpty()){
                                ...
                                eb.setThumbnail(Cat.jda.getSelfUser().getAvatarUrl());
                        ...
                        if(args.length == 1){
                            ...
                            eb2.setFooter("© kirstenjbx's Shed", Cat.jda.getSelfUser().getAvatarUrl());
                            ...
                            e.getGuild().getTextChannelById("835573296422060042").sendMessageEmbeds(eb.build(), eb2.build(), eb3.build()).queue();
                        }
